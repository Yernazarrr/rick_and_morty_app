...
class _CharacterApiService implements CharacterApiService {
  _CharacterApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<CharactersResponseModel> getCharacters(
    ...
    final _options = _setStreamType<CharactersResponseModel>(
    ...
    late CharactersResponseModel _value;
    try {
      _value = CharactersResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<List<CharacterModel>> getCharactersByIds(String ids) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
