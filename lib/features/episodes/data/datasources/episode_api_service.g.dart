...
class _EpisodeApiService implements EpisodeApiService {
  ...
  Future<EpisodesResponseModel> getEpisodes(
    ...
    final _options = _setStreamType<EpisodesResponseModel>(
  ...
  Future<EpisodeModel> getEpisode(int id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<EpisodeModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/episode/${id}',
  ...
  @override
  Future<List<EpisodeModel>> getEpisodesByIds(String ids) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<EpisodeModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/episode/${ids}',
